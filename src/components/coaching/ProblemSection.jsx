      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mt-20 flex items-center gap-8 justify-center">
          <div className="text-center">
            <div className="w-20 h-20 mx-auto rounded-full border-2 border-dashed border-white/20 flex items-center justify-center mb-3">
              <div className="w-3 h-3 bg-red-400/60 rounded-full" />
            </div>
            <p className="text-xs text-white/30 uppercase tracking-wider font-semibold">Aktionismus</p>
          </div>
          <div className="flex-1 max-w-xs h-px bg-gradient-to-r from-white/10 via-white/30 to-white/10 relative">
            <ArrowRight className="w-5 h-5 text-white/30 absolute right-0 -top-2.5" />
          </div>
          <div className="text-center">
            <div className="w-20 h-20 mx-auto rounded-full border-2 border-[#F0EAD6]/40 flex items-center justify-center mb-3">
              <div className="w-3 h-3 bg-[#F0EAD6] rounded-full" />
            </div>
            <p className="text-xs text-[#F0EAD6]/60 uppercase tracking-wider font-semibold">Hebelanalyse</p>
          </div>
        </div>
      </div>
    </section>
