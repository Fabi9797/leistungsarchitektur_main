...
const bullets = [
  "Lerne, welche Faktoren bei dir wirklich über Abnehmen oder Stillstand entscheiden.",
  "Verstehe, wie du Training, Ernährung und Alltag effizient kombinierst – auch mit wenig Zeit.",
    ...
    <section className="relative min-h-screen flex items-center bg-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 pt-16 pb-14 lg:pt-32 lg:pb-24 w-full">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            {/* Proof Line */}
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 sm:px-4 sm:py-2 bg-[#F0EAD6] rounded-full mb-6 sm:mb-8">
            ...
            <div className="lg:hidden mt-6 rounded-2xl overflow-hidden shadow-xl" style={{ aspectRatio: "16/9" }}>
              <iframe
                src="https://www.youtube.com/embed/NQ-fUsB7gec"
